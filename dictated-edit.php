...
if ($DICTATE_TYPE == 'Approve')
	{
		...
		mysqli_query($dbconnect,"insert into xray_log (USER,IP,EVENT,URL, MRN, ACCESSION)VALUES ('$userlogin','$IP','EDIT REPORT','$URL', '$MRN', '$ACCESSION')");
	}
...
if ($DICTATE_TYPE == 'Save')
	{
		...
		$IP=getenv('REMOTE_ADDR');
		$URL=$_SERVER["HTTP_REFERER"];
		mysqli_query($dbconnect,"insert into xray_log (USER,IP,EVENT,URL, MRN, ACCESSION)VALUES ('$userlogin','$IP','EDIT REPORT SAVE','$URL', '$MRN', '$ACCESSION')");
	}
