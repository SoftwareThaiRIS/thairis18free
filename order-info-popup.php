...
while($row1 = mysqli_fetch_array($result1))
		{
			$PT_NAME = $row1['NAME'];
			$PT_LASTNAME = $row1['LASTNAME'];
			$PT_DOB = $row1['BIRTH_DATE'];
			$SEX = $row1['SEX'];
...
echo "MRN : <a href=patient-info-popup.php?MRN=".$MRN.">".$MRN."</a><br />";// <a href=patient-edit.php?MRN=".$MRN.">Edit</a><br />";
echo "Name : $PT_NAME  $PT_LASTNAME<br />";
echo "Age : ".AgeCal($PT_DOB)." <br/> Sex : $SEX<br />";
echo "DOB : $PT_DOB<br />";
echo "</td></tr>";
echo "<tr><td bgcolor=#79acf3 width=100% align=center>";	
