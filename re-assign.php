...
$MRN = $_POST['MRN'];
$datestart = date("Y-m-d",mktime(0, 0, 0, date("m"), date("d")-30,date("Y"))); // Yesterday
?>
 <!DOCTYPE html>
<html>
<head>
...
$sql = "SELECT xray_patient_info.MRN, 
			...
			LEFT JOIN xray_user ON (xray_user.ID = xray_request_detail.ASSIGN_ID) 
			...
			AND (xray_request_detail.REQUEST_DATE between '$datestart' AND DATE(NOW()))
