function change_procedure(ORDERID,MRN)
{
var openct;
var MRN = MRN;
var ORDERID = ORDERID;
...
openct.open("GET","order-change.php?"+HHN+MRN+AAND+TTYPE+TYPE+AAND+ORDER1+ORDERID+AAND+Math.random(),true);
openct.send(null);
  }
...
function add_cart(ORDERID,XRAYCODE,MRN)
{
var addcart;
var ORDERID = ORDERID;
var MRN = MRN;
...
addcart.open("GET","order-change-update.php?MRN="+MRN+AAND+XCODE+XRAYCODE+AAND+ORDER1+ORDERID+AAND+Math.random(),true);
addcart.send(null);
  }
...
function search_procedure(MRN)
{
var openct;
var MRN = MRN;
var TTYPE = "TYPE=SEARCHTEXT";
var AAND = "&";
var HHN = "HN=";
var REFERRER = document.referrerform.referrer.value;
var DEPARTMENT = document.departmentform.department_selected.value;
var DEP = "DEPARTMENT=";
var REFER = "REFERRER=";
var PPTEXT = "PROCEDURETEXT=";
var PROCEDURETEXT = document.procedureform.proceduretext.value;
...
//req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=tis-620"); // set Header
openct.open("GET","createorder2.php?"+HHN+MRN+AAND+TTYPE+AAND+REFER+REFERRER+AAND+PPTEXT+PROCEDURETEXT+AAND+DEP+DEPARTMENT+AAND+Math.random(),true);
openct.send(null);
  }
