...
echo "<center><table bgcolor=#F0F0F0 ><tr><td>";
				...
				echo "<input type=radio name=readtime id=radio1 value=1>Now<br />";
				echo "<input type=radio name=readtime id=radio2 value=2>1 Day<br />";
				...
				////////////////////////////////
				echo "<input type=radio name=readtime id=radio3 value=3>Select Date";
